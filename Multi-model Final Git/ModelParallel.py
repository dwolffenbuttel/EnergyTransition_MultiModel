...
from ema_workbench import (RealParameter, CategoricalParameter, ArrayOutcome,
                           TimeSeriesOutcome, ema_logging,
...
if __name__ == '__main__':
    ...
    multi_model.ABMsavelist = ['"Amsterdam"', '"Rotterdam"',
                               '"Arnhem"', '"Zwartewaterland"'] # Double quotes needed for netlogo
    ...
    no_categorical_results = ['SD_Average Gas Price', 'SD_Average Electricity Price',
                              'SD_Average Heat Price', 'SD_National Energy System Distribution[Natural Gas]',
                              ...
                              'SD_Electricity Trade','System Distributions', 'Total Electricity use',
                              'Municipality Data']
