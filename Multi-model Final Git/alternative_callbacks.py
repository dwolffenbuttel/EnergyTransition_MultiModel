...
from ema_workbench.util import ema_exceptions, get_module_logger
from ema_workbench.em_framework.parameters import (CategoricalParameter, IntegerParameter,
                         BooleanParameter)
...
class Extra_dim_Callback(AbstractCallback):
    """
    ...
    def __init__(self, uncs, levers, outcomes, nr_experiments,
        ...
        '''
        super(Extra_dim_Callback, self).__init__(uncs, levers, outcomes,
                                              nr_experiments,
                                              reporting_interval,
                                              reporting_frequency)
        self.i = 0
    ...
    def __call__(self, experiment, outcomes):
        ...
        '''
        super(Extra_dim_Callback, self).__call__(experiment, outcomes)
